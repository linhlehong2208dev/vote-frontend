...
function BarChart({
  ...
  ranking: GameDashboard["questions"][number]["ranking"];
}) {
  ...
  return (
    <div className="min-h-screen bg-stage-950 text-white">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-stage-950/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
          ...
          <div className="min-w-0 flex-1 px-4 text-center">
            ...
            <p className="text-[10px] font-extrabold uppercase tracking-[.2em] text-amber">
              GAME DASHBOARD
            </p>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-5 py-7">
        {error && (
          <div className="mb-5 rounded-2xl border border-coral/30 bg-coral/10 p-4 text-sm text-coral">
            {error}
          </div>
        )}
